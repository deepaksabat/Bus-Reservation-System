                                ...
                                <tr>
                                    ...
                                    <td>  
                                        <ul class="list-unstyled text-right" style="text-align: right">
                                            ...
                                            <span><?php echo (!empty($ticket->tkt_passenger_id_no)?$ticket->tkt_passenger_id_no:null) ?></span></li>
                                            <li>
                                            <strong>Trip ID :</strong> 
                                            <span><?php echo (!empty($ticket->trip_id_no)?$ticket->trip_id_no:null) ?></span></li>
                                        </ul>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <th class="text-right"><?php echo $currency; ?><?php echo $price = (!empty($ticket->price)?$ticket->price:0) ?>   <?php echo $appSetting->currency; ?></th>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <th>Discount</th>
